...
columns. Observations are the level of items in orders by user. There
are user/order variables – user ID, order ID, order day, and order hour.
...
Load and tidy accelerometer dataset. Q1:pivot longer - minute of the
day, activity count; check if min of day is in numeric or other format,
tweak var - useful var names
